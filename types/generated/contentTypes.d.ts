...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    work_cards: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiExecutorExecutor extends Struct.CollectionTypeSchema {
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    publicatedAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    work_card: Schema.Attribute.Relation<
      'oneToOne',
      'api::work-card.work-card'
    >;
    users_permissions_user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    executor: Schema.Attribute.Relation<'oneToOne', 'api::executor.executor'>;
...
export interface ApiWorkCardWorkCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publicatedAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    finishedIn: Schema.Attribute.Date & Schema.Attribute.Required;
    ...
    price: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u041F\u043E \u0434\u043E\u0433\u043E\u0432\u043E\u0440\u0435\u043D\u043D\u043E\u0441\u0442\u0438'>;
    subject_types: Schema.Attribute.Relation<
      'oneToMany',
      'api::subject-type.subject-type'
    >;
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    executor: Schema.Attribute.Relation<'manyToOne', 'api::executor.executor'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
